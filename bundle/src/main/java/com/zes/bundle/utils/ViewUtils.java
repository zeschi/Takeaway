...
public class ViewUtils {
    ...
    public static int getResId(String resName, String defType) {
        try {
            ...
            Resources resources = MyApplication.getInstance().getPackageManager().getResourcesForApplication(packageName);
...
//		MToast.showMessage(messageId);
        Toast.makeText(MyApplication.getInstance(), messageId, Toast.LENGTH_SHORT).show();
    }
