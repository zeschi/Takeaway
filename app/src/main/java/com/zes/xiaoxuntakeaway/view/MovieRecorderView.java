package com.zes.xiaoxuntakeaway.view;
...
public class MovieRecorderView extends LinearLayout implements MediaRecorder.OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWidth = a.getInteger(R.styleable.MovieRecorderView_mv_width, 320);// 默认320
        mHeight = a.getInteger(R.styleable.MovieRecorderView_mv_height, 240);// 默认240
        ...
        mProgressBar = (ProgressBar) findViewById(R.id.progress_movie);
    ...
    private void createRecordDir() {
        ...
        File sampleDir = new File(Environment.getExternalStorageDirectory()
                + File.separator + "zes/video/");//录制视频的保存地址
        if (!sampleDir.exists()) {
            sampleDir.mkdirs();
        }
